...
function cartUpload(){
   ...
   let pedido = document.createElement('div');
   pedidos.classList.add('pedidos');
   pedidos.innerHTML = '<p>There are currently no products in your cart. We invite you to browse our selection.</p><p> For your convenience, we accept numerous payment methods (credit cards, PayPal, etc.) and guarantee an efficient, global shipping process to ensure your order reaches any destination.</p><br><p>Actualmente no hay productos en su carrito. Le invitamos a explorar nuestra selección de productos.</p><p> Para su comodidad, aceptamos numerosos métodos de pago (tarjetas de crédito, PayPal, etc.) y garantizamos un proceso de envío global eficiente para que su pedido llegue a cualquier destino.</p><br><p>Votre panier est actuellement vide. Nous vous invitons à parcourir notre sélection.</p><p> Pour votre confort, nous acceptons de nombreux modes de paiement (cartes bancaires, PayPal, etc.) et garantissons une livraison internationale rapide et efficace, où que vous soyez.</p><br><p>Al momento non ci sono prodotti nel tuo carrello. Ti invitiamo a sfogliare la nostra selezione.</p><p> Per la tua comodità, accettiamo numerosi metodi di pagamento (carte di credito, PayPal, ecc.) e garantiamo un processo di spedizione efficiente e globale per garantire che il tuo ordine raggiunga qualsiasi destinazione.</p><br><p>Ihr Warenkorb ist derzeit leer. Wir laden Sie ein, unser Sortiment zu durchstöbern.</p><p> Für Ihren Komfort akzeptieren wir zahlreiche Zahlungsmethoden (Kreditkarten, PayPal usw.) und garantieren einen effizienten, weltweiten Versand, damit Ihre Bestellung jedes Ziel erreicht.</p>';
