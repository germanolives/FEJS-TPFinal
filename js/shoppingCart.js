...
function cartUpload(){
   ...
   let pedido = document.createElement('div');
   pedidos.classList.add('pedidos');
   pedidos.innerHTML = '<span class="pedidosLang"><img src="./img/flags/UK.webp" width="35" height="20"><p>There are currently no products in your cart. We invite you to browse our selection.</p><p> For your convenience, we accept numerous payment methods <strong>(credit cards, PayPal, etc.)</strong> and guarantee an efficient, global shipping process to ensure your order reaches any destination.</p></span><br><span class="pedidosLang"><img src="./img/flags/SP.webp" width="35" height="20"><p>Actualmente no hay productos en su carrito. Le invitamos a explorar nuestra selección de productos.</p><p> Para su comodidad, aceptamos numerosos métodos de pago <strong>(tarjetas de crédito, PayPal, etc.)</strong> y garantizamos un proceso de envío global eficiente para que su pedido llegue a cualquier destino.</p></span><br><span class="pedidosLang"><img src="./img/flags/FR.webp" width="35" height="20"><p>Votre panier est actuellement vide. Nous vous invitons à parcourir notre sélection.</p><p> Pour votre confort, nous acceptons de nombreux modes de paiement <strong>(cartes bancaires, PayPal, etc.)</strong> et garantissons une livraison internationale rapide et efficace, où que vous soyez.</p></span><br><span class="pedidosLang"><img src="./img/flags/IT.webp" width="35" height="20"><p>Al momento non ci sono prodotti nel tuo carrello. Ti invitiamo a sfogliare la nostra selezione.</p><p> Per la tua comodità, accettiamo numerosi metodi di pagamento <strong>(carte di credito, PayPal, ecc.)</strong> e garantiamo un processo di spedizione efficiente e globale per garantire che il tuo ordine raggiunga qualsiasi destinazione.</p></span><br><span class="pedidosLang"><img src="./img/flags/DE.webp" width="35" height="20"><p>Ihr Warenkorb ist derzeit leer. Wir laden Sie ein, unser Sortiment zu durchstöbern.</p><p> Für Ihren Komfort akzeptieren wir zahlreiche Zahlungsmethoden <strong>(Kreditkarten, PayPal usw.)</strong> und garantieren einen effizienten, weltweiten Versand, damit Ihre Bestellung jedes Ziel erreicht.</p></span>';
